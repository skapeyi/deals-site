...
class UserLocationController extends DoneDealController
{
    ...
    /**
     * Displays a single UserLocation model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new UserLocation model.
    ...
    /**
     * Updates an existing UserLocation model.
    ...
    /**
     * Deletes an existing UserLocation model.
    ...
    /**
     * Finds the UserLocation model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return UserLocation the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UserLocation::findOne($id)) !== null) {
            return $model;
        } else {
